...
def argparse_init():
    ...
    parser.add_argument("--data_url", type=str, default="./test_raw_data/",
    ...
    parser.add_argument("--ckpt_url", type=str, default="/wide-deep-weipin/ckpt/",
                        help="The location of the checkpoint file.")
    return parser
...
def data_argparse_init():
    ...
    parser.add_argument("--data_file", type=str, default="train_demo.txt", help='The data file')
