...
def moxing_wrapper(run_func, data_dir="/cache/data", train_dir="/cache/train"):
    def func(args_opt):
        sync_dataset(args_opt.data_url)
        print("Finish download dataset.")
        args_opt.data_dir = data_dir
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_url", type=str, default="", help="training url")
    parser.add_argument("--train_url", type=str, default="", help="dataset url")

    args_opt = parser.parse_args()
    numpy.random.seed(0)
    run_pretrain(args_opt)
